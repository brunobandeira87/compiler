 ...
 * arquivos.<br> <br> Exemplo de Uso: <br> <br> <code> // Abre os arquivos de
 * entrada e sa���da <br> Arquivo io = new Arquivo("L1Q1.in", "L1Q1.out"); <br>
 * <br> // L��� dados do arquivo de entrada <br> String s = io.readString();
 * <br> char c = io.readChar(); <br> int i = io.readInt(); <br> double d =
 * io.readDouble(); <br> <br> // Grava dados no arquivo de sa���da <br>
 * io.print("Algoritmos"); <br> io.print(35); <br> io.println(2.3); <br> <br> //
 * Fecha o arquivo ap���s o uso <br> io.close(); <br> </code>
 *
 * @author Emannuel Mac���do (egm@cin.ufpe.br)
 */
...
public class Arquivo {
	 ...
	 * e o arquivo de sa���da no modo grava������o. Se o arquivo de sa���da j���
	 * existir, seu conte���do ��� descartado.
	 *
	 * @param in
	 *            nome do arquivo de entrada de dados
	 * @param out
	 *            nome do arquivo de sa���da de dados
	 */
	public Arquivo(String in) {
		...
		try {
			...
			// abre o arquivo de sa���da no modo grava������o
	...
	/**
	 * Grava os dados do buffer no arquivo. Isto ��� feito automaticamente a
	 * cada quebra de linha (<code>println</code>).
	 */
	public void flush() {
		this.out.flush();
	}
	 ...
	 *
	 * @param c
	 *            caractere que ser��� escrito no arquivo
	 */
	 ...
	 *
	 * @param d
	 *            n���mero que ser��� escrito no arquivo
	 ...
	 *            n���mero que ser��� escrito no arquivo
	 * @param dec
	 *            n���mero de casas decimais de precisao
	 * @exception IOException
	 *                em caso de erro de I/O
	 */
	 ...
	 *
	 * @param s
	 *            string que ser��� escrita no arquivo
	 */
	 ...
	 *
	 * @param d
	 *            n���mero que ser��� gravado no arquivo
	 * @exception IOException
	 *                em caso de erro de I/O
	 */
	 ...
	 *
	 * @param s
	 *            string que ser��� gravada no arquivo
	 */
	...
	/**
	 * L��� o pr���ximo caractere do arquivo, incluindo espa���os (' ') e
	 * quebras de linha ('\n'). Se o fim do arquivo for alcan���ado, o caractere
	 * nulo ('\0') ��� retornado.
	 *
	...
	/**
	 * L��� uma linha do arquivo. Se parte da linha j��� foi lida, ent���o o
	 * restante ��� retornado, mesmo que seja uma linha em branco (String de
	 * tamanho zero).
	 *
